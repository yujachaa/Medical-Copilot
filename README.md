...
1. **AI 진단 및 병증 탐지** ✨
   - 흉부 X-Ray 이미지에서 YOLO v8 모델로 병증 위치 탐지 및 의료 특화 VLM 모델(LLaVA-Med)을 통해 병증을 진단하여 보고서로 제공합니다!
...
5. **서비스 이용자 관리**
   - Medical Copilot 서비스는 Onpremise 방식으로 제공됩니다. 서비스를 이용하는 병원 고객 각각의 서비스 이용량 및 통계 정보를 클라우드 서비스로 제공합니다.
